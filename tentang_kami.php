...
<head>
    ...
    <style>
        ...
        /* Styling Khusus untuk Banner Tentang Kami */
        .about-hero {
            position: relative;
            background-image: url('backround_foto_kami.jpg'); /* Ganti dengan path gambar kamu jika berbeda */
        ...
        /* Overlay gelap agar teks di atas gambar terbaca */
        .about-overlay {
            background: linear-gradient(to right, rgba(26, 83, 25, 0.9) 0%, rgba(52, 168, 83, 0.7) 100%);
            padding: 4rem 3rem;
            color: white;
            min-height: 350px;
            display: flex;
    ...
    <main class="max-w-5xl mx-auto px-6 py-10 flex-grow w-full">
        ...
        <div class="about-hero">
            <div class="about-overlay">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold mb-4 leading-tight">Misi Kami: Mengubah Sampah Menjadi Daya</h1>
                <p class="text-lg text-green-50 max-w-2xl font-medium leading-relaxed">
                    Setiap tahun, Indonesia menghasilkan puluhan juta ton sampah, namun angka daur ulang nasional kita masih sangat memprihatinkan. Sebagian besar sampah botol plastik dan kaleng hanya berakhir di TPA, mencemari tanah, atau hanyut ke lautan.
                </p>
            </div>
        </div>

        <div class="content-card">
            <h2 class="text-2xl font-extrabold text-gray-800 mb-4">Melihat Potensi, Bukan Hanya Masalah</h2>
            <p class="text-gray-600 leading-relaxed font-medium mb-6 text-justify">
                Di <span class="font-bold text-[#34A853]">Trash2Power</span>, kami melihat sampah bukan sebagai masalah akhir, melainkan sebagai potensi besar yang belum terjamah. Jika sampah adalah masalah, maka insentif adalah kuncinya. Kami menghadirkan sebuah ekosistem daur ulang digital, sebuah platform inovatif yang menjembatani masyarakat dengan rantai daur ulang melalui teknologi.
            </p>
            <p class="text-gray-600 leading-relaxed font-medium text-justify">
                Kami percaya bahwa setiap botol plastik dan kaleng aluminium yang kamu miliki memiliki nilai nyata. Oleh karena itu, kami menciptakan solusi untuk memastikan sampah tersebut tidak terbuang sia-sia.
            </p>
        </div>
