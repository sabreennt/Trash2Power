...
<head>
    ...
    <title>Isi Token Listrik - Trash2Power</title>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="hidden lg:block glass-card p-6">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed">Pastikan Nomor Meter atau ID Pelanggan yang Anda masukkan sudah benar dan sesuai. Kode token akan muncul di riwayat transaksi dalam waktu sekitar 1-5 menit.</p>
                </div>
            </div>

            <div class="lg:col-span-8">
                <div class="glass-card p-8">
                    <h4 class="font-black text-gray-800 mb-6">Pilih Token Listrik</h4>
                    
                    <form action="" method="POST" id="formPenukaran">
                        <div class="mb-8">
                            <label class="block text-xs font-black text-gray-400 uppercase tracking-wider mb-2">Masukan nomor Token Listrik</label>
                            <div class="relative">
                                ...
                                <input type="number" name="nomor_tujuan" id="nomorTujuan" 
                                    ...
                                    placeholder="masukan angka" required oninput="checkInputs()">
                            </div>
                        </div>

                        <input type="hidden" name="jenis_penukaran" value="listrik">
                        <input type="hidden" name="nominal" id="inputNominal">
                        <input type="hidden" name="harga" id="inputHarga">

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="product-item" onclick="selectProduct(this, 100, 100)">
                                <span class="block text-gray-400 text-xs font-bold mb-1">Nominal</span>
                                <div class="flex justify-between items-center">
                                    <h3 class="product-nominal mb-0">100</h3>
    ...
    <script>
        ...
        function checkInputs() {
            ...
            if (nomor.length >= 9 && nominal !== "") {
                ...
                btnSubmit.textContent = "Pilih Nominalr";
            }
        }
    </script>
</body>
