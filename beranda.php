...
$status_db = $r['status'] ?? 'sedang diproses';

// Tentukan warna berdasarkan isi status
if ($status_db == 'sedang diproses') {
    $warna = "bg-yellow-100 text-yellow-700";
} elseif ($status_db == 'saldo berhasil masuk') {
    $warna = "bg-green-100 text-[#34A853]";
} else {
