...
<head>
    ...
    <style>
        ...
        * {
        ...
        .container {
            width: 90%;
            max-width: 1100px; /* Lebar optimal desktop */
        ...
        .card-uang { background-color: #dcfce7; }
        .card-disetor { background-color: #f1f5f9; }
        .card-riwayat { background-color: #e2e8f0; cursor: pointer; }

        .card-icon { font-size: 1.8rem; }
        .card-info span { font-size: 0.8rem; color: #64748b; font-weight: 600; }
        .card-info h3 { font-size: 1.2rem; color: #1e293b; }
        ...
        .info-box h3 { margin-bottom: 10px; font-size: 1.2rem; color: #1e293b; }
        .info-box p { font-size: 0.95rem; color: #475569; margin-bottom: 20px; }
        
        .rules { margin-top: 15px; }
        .rules strong { display: block; margin-bottom: 5px; }
        .rules ul { margin-left: 20px; margin-bottom: 15px; font-size: 0.95rem; }
        ...
        .cta-text h3 { font-size: 1.4rem; margin-bottom: 8px; }
        .cta-text p { color: #64748b; margin-bottom: 20px; line-height: 1.4; }
