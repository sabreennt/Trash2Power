...
function deteksiProvider($nomor) {
    $prefix = substr($nomor, 0, 4);
    $list = [
        'Telkomsel' => ['0811', '0812', '0813', '0821', '0822', '0823', '0852', '0853', '0851'],
        'Indosat'   => ['0814', '0815', '0816', '0855', '0856', '0857', '0858'],
        'XL/Axis'   => ['0817', '0818', '0819', '0831', '0832', '0833', '0838', '0859', '0877', '0878'],
        'Tri'       => ['0895', '0896', '0897', '0898', '0899'],
        'Smartfren' => ['0881', '0882', '0883', '0884', '0885', '0886', '0887', '0888', '0889']
    ];
    foreach ($list as $nama => $pref) {
        if (in_array($prefix, $pref)) return $nama;
    }
    return "Operator";
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_penukaran'])) {
   ...
   $provider = deteksiProvider($_POST['nomor_tujuan']); 
    $harga = $_POST['harga'];
                ...
                <div class="glass-card p-8">
                    ...
                    <form action="" method="POST" id="formPenukaran">
                        <div class="mb-8">
                            ...
                            <div class="relative">
                                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 font-bold">08</span>
                                <input type="number" name="nomor_tujuan" id="nomorTujuan" 
                                    ...
                                    placeholder="0812345678xx" required oninput="checkInputs()">
                            </div>
                        </div>
